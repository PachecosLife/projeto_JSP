<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <head>
    <title>Java Server Pages</title>
      ...
      <meta name="Jsp project" content="Meu projeto JSP." />
      <meta name="Fellipe Pacheco" content="codedthemes" />
      
      <!-- FAVICON  -->
      <link rel="icon" href="assets/images/faviconbr.ico" type="image/x-icon">
   	 <!-- Google font-->
